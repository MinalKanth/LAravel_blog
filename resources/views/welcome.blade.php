...
@section('content')
    ...
    <section class="blog-area section">
        <div class="container">
                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ Storage::disk('public')->url('post/'.$post->image) }}" alt="{{ $post->title }}"></div>
                                 ...
                                 <a class="avatar" href="{{ route('author.createprofile',$post->user->user_name) }}"><img src="{{ Storage::disk('public')->url('profile/'.$post->user->image) }}" alt="Profile Image"></a>

                                <div class="blog-info">

                                    <h4 class="title"><a href="{{ route('post.viewdetails',$post->slug) }}"><b>{{ $post->title }}</b></a></h4>
            ...
            <a class="load-more-btn" href="{{ route('post.viewindex') }}"><b>LOAD MORE</b></a>
